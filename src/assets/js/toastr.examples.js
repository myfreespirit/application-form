(function($){
	...
	if ($toastr_error.length > 0 ) {
		$toastr_error.on("click", function(){
            ...
            toastr.error('<em class="ti ti-na toast-message-icon"></em> You are not eligible for EXRT distribution. Get at least 10M EXRN, or try with a different wallet address.');
		});
	}
